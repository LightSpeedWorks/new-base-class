...
# use [base-class-extend](https://www.npmjs.org/package/base-class-extend)!
...
[Japanese version/■日本語版はこちら■](https://github.com/LightSpeedWorks/base-class-extend/blob/master/README-JP.md#readme)
